...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Tesla developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Tesla"
...
#define PACKAGE_BUGREPORT "Https://github.com/Open-Pool"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tesla"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tesla 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tesla"
